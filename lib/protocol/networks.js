...
main.deploys = [main.deployments.hardening, main.deployments.testdummy];
...
simnet.pow.targetTimespan = simnet.pow.targetWindow * simnet.pow.targetSpacing;
...
simnet.deploys = [simnet.deployments.hardening, simnet.deployments.testdummy];
