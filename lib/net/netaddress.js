...
class NetAddress extends bio.Struct {
  ...
  getKey(enc) {
    ...
    if (enc === "base32") return base32.encode(this.key);

    if (enc === "hex") return this.key.toString("hex");
...
NetAddress.DEFAULT_SERVICES =
  0 | common.services.NETWORK | common.services.BLOOM;
