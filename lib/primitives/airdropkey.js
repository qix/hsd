...
class AirdropKey extends bio.Struct {
  ...
  getJSON() {
    return {
      ...
      n: this.n.length > 0 ? this.n.toString("hex") : undefined,
      e: this.e.length > 0 ? this.e.toString("hex") : undefined,
      C1: this.C1.length > 0 ? this.C1.toString("hex") : undefined,
      point: this.point.length > 0 ? this.point.toString("hex") : undefined,
      version: this.address.length > 0 ? this.version : undefined,
      address:
        this.address.length > 0 ? this.address.toString("hex") : undefined,
      value: this.value || undefined,
      sponsor: this.value ? this.sponsor : undefined,
      nonce:
        !this.isGoo() && !this.isAddress()
