...
describe("Wallet RPC Methods", function () {
  ...
  describe("getaddressinfo", () => {
    ...
    const pubkeys = [
      Buffer.from(
        "03253ea6d6486d1b9cc3a" +
          "b01a9a321d65c350c6c26a9c536633e2ef36163316bf2",
        "hex"
      ),
      Buffer.from(
        "02cd38edb6f9cb4fd7380" +
          "3b49aed97bfa95ef402cac2c34e8f551f8537811d2159",
        "hex"
      ),
    ];
  ...
  describe("signmessage", function () {
    ...
    it("should verify an externally signed message", async () => {
      ...
      const signature =
        "ymnS7vTpo+IBWliXWnubTD7UX2aTbzLT5qg5btFxNlYBq" +
